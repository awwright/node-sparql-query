...
module.exports.evaluateQuery = function(dataGraph, query, objectBindings){
	...
	switch(query.queryType){
		...
		case 'update':
			...
			var deletePattern = null;
			var insertPattern = null;
	...
	query.where.forEach(function(block){
		if(block.type=='bgp'){
			...
			throw new Error('Unknown block type '+JSON.stringify(block.type));
		}
	});
